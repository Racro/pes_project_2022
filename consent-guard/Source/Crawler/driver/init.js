...
function GetBrowserOptions(config) {
     ...
     */
    const ext1 = __dirname + config.extensionPath + "Consent_O_Matic";
    const ext2 = __dirname + config.extensionPath1 + "ghostery";
    return {
        ...
        args: [
            ...
            "--load-extension=" + __dirname + config.extensionPath1,
